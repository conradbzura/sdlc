...
| `sdlc_review` | 6th | Review an open PR (diff) **or** a set of local file paths/globs, writing a consolidated local review document under `.sdlc/reviews/` (no GitHub posting) |
